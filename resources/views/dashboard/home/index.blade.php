...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
            <div>
                <h2 class="main-content-title fs-24 mb-1">{{ __('Welcome To Dashboard') }}</h2>
                        ...
                        <div class="card bg-primary custom-card card-box">
                            <div class="card-body p-4">
                                <div class="row align-items-center">
                                    ...
                                    <img src="{{ asset('dashboard/assets/images/pngs/29.png')}}" alt="user-img">
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="avatar-list-stacked my-auto float-end">
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                                src="{{ asset('dashboard/assets/images/faces/1.jpg')}}">
                                                        </div>
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                        ...
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                                src="{{ asset('dashboard/assets/images/faces/3.jpg')}}">
                                                        </div>
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                                src="{{ asset('dashboard/assets/images/faces/4.jpg')}}">
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <div class="avatar-list-stacked my-auto float-end">
                                                        ...
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                                src="{{ asset('dashboard/assets/images/faces/6.jpg')}}">
                                                        </div>
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                                src="{{ asset('dashboard/assets/images/faces/7.jpg')}}">
                                                        </div>
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                                src="{{ asset('dashboard/assets/images/faces/8.jpg')}}">
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <div class="avatar-list-stacked my-auto float-end">
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                                src="{{ asset('dashboard/assets/images/faces/11.jpg')}}">
                                                        </div>
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                                src="{{ asset('dashboard/assets/images/faces/12.jpg')}}">
                                                        </div>
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                                src="{{ asset('dashboard/assets/images/faces/9.jpg')}}">
                                                        </div>
                                                        <div class="avatar avatar-rounded avatar-sm">
                                                            <img alt="avatar" class="rounded-circle"
                                                                src="{{ asset('dashboard/assets/images/faces/10.jpg')}}">
                                                        </div>
                                                    </div>
                                                </td>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <img src="{{ asset('dashboard/assets/images/pngs/28.png')}}" alt="image" class="best-emp">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col col-auto">
                                <div class="mt-3">
                                    <div class="">
                                        <img alt="" class="ht-50"
                                            src="{{ asset('dashboard/assets/images/pngs/21.png')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
